...
![Home Screen Light](docs/media/screenshots/atm-home-light.png)

#### Home Screen Dark Mode

![Home Screen Dark](docs/media/screenshots/atm-home-dark.png)

### Typing Test

![Typing Test](docs/media/gifs/typing-test.gif)

### Word Falling Game

![Word Falling Game](docs/media/gifs/word-falling.gif)

### Letter Rain Game

![Letter Rain Game](docs/media/gifs/letter-rain.gif)

### Word Stack Game

![Word Stack Game](docs/media/gifs/word-stack.gif)
...
### ![built in Japan](https://shieldcn.dev/flag/af.svg)
